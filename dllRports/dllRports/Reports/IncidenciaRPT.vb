...
Public Class IncidenciaRPT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IncdenciasPC.IncidenciaRPT.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_IdIncidencia() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedIncidenciaRPT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As IncidenciaRPT = New IncidenciaRPT()
        rpt.Site = Me.Site
        Return rpt
    End Function
